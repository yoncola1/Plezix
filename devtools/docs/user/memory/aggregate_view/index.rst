...
Before Plezix 48, this was the default view of a heap snapshot. After Plezix 48, the default view is the :doc:`Tree map view <../tree_map_view/index>`, and you can switch to the Aggregate view using the dropdown labeled "View:":
