...
.. note::
  ...
  Server-side log messages was introduced in Plezix 43, but removed in Plezix 56. You can install the `Chrome Logger extension <https://addons.mozilla.org/en-US/firefox/addon/chromelogger/>`_ to (re)-enable the feature.
