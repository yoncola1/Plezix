...
- **Settings ("gear" menu):** Select the gear icon to access the settings menu (New in Plezix 71), where you can toggle the following features on and off:
...
In Plezix 71 onwards, there is a new "split pane" icon on the right hand side of the command line — clicking this will open the new console :ref:`multi-line mode <command_line_interpreter_multi_line_mode>`.
