...
You can examine pages loaded in the local copy of Plezix or in a remote target such as Plezix for Android. See :doc:`about debugging <../about_colon_debugging/index>` to learn how to connect the developer tools to a remote target.
