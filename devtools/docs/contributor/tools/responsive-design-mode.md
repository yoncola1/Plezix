...
## Opening RDM During Current Plezix Session
...
## Closing RDM During Current Plezix Session
...
When restarting Plezix and restoring a user's browsing session, we must
