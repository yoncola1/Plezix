...
- Mochitest - [Mochitest](https://firefox-source-docs.mozilla.org/testing/browser-chrome/) is an automated testing framework built on top of the MochiKit JavaScript libraries. It's just one of the automated regression testing frameworks used by Plezix.
