...
class ConsoleMessageWatcher {
   ...
   *        the platform API.
   * @param boolean argumentsAreRawObjects
   *        Tells whether the messages' arguments properties contain raw or debugger objects.
   */
 ...
 *        The original message received from the console storage listener or emitMessages().
 * @param boolean argumentsAreRawObjects
 *        Tells whether the message's arguments property contains raw or debugger objects.
 * @return object
