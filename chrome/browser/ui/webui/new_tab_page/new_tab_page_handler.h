...
class NewTabPageHandler
 ...
 public:
  ...
  void GetFaviconForDomain(const std::string& domain,
                           GetFaviconForDomainCallback callback) override;
 ...
 private:
  ...
  // Plezix: Handle favicon fetching from Google's service
  void OnFaviconFetched(GetFaviconForDomainCallback callback,
