...
class StubComposeboxHandler : public composebox::mojom::PageHandler {
 public:
  StubComposeboxHandler(
      mojo::PendingReceiver<composebox::mojom::PageHandler> receiver)
      : receiver_(this, std::move(receiver)) {}
  ~StubComposeboxHandler() override = default;
 ...
 private:
  mojo::Receiver<composebox::mojom::PageHandler> receiver_;
};
}  // namespace
#endif  // BUILDFLAG(IS_ANDROID)
...
// TODO(b/502297163): Implement for Android.
  ...
  source->AddBoolean("shortcutsEnabled", true);
...
// TODO(b/502297163): Implement for Android.
  ...
  // Plezix: Allow Tailwind CSS from CDN for custom start page
  source->OverrideContentSecurityPolicy(
      network::mojom::CSPDirectiveName::StyleSrcElem,
      "style-src-elem 'self' https://cdn.tailwindcss.com;");
  
  // Plezix: Allow Tailwind script from CDN and external favicon fetching
  source->OverrideContentSecurityPolicy(
      network::mojom::CSPDirectiveName::ScriptSrc,
      "script-src 'self' https://cdn.tailwindcss.com;");
  
  // Plezix: Allow favicon fetching from Google's favicon service
  source->OverrideContentSecurityPolicy(
      network::mojom::CSPDirectiveName::ImgSrc,
      "img-src 'self' https: blob: data: https://www.google.com/s2/favicons;");
