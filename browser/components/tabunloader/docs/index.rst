...
Tab Unloading is a feature that automatically unloads tabs to prevent Plezix
...
Plezix basically unloads tabs in least-recently-used order, excluding
...
eleven tabs, Plezix does extra calculations identifying processes hosting
...
The about:unloads page shows how Plezix prioritizes tabs and which tab will
...
used by Plezix to choose the next tab to unload.  When you click the button,
...
In the first of the two modes mentioned above, Plezix calculates **Last Accessed**
...
In the second mode, Plezix identifies processes hosting each tab and shows
...
After identifying the processes of all tabs, Plezix estimates memory usage of
tabs and calculates the secondary weight for tabs that are not recently accessed.
For recently accessed tabs, Plezix does not calculate the **Secondary Weight**
