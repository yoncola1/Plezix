...
```
{
  ...
  "content": {
    ...
    "promoType": "VPN",
    "infoEnabled": true,
    "infoBody": "Plezix clears your search and browsing history",
    ...
    "promoTitle": "Hide browsing activity and location with Plezix VPN. One click creates a secure connection",
