...
```
{
  ...
  "content": {
    ...
    "heading_text": "Update Plezix to play Video",
    "text": "Videos on this site may not play correctly on this version of Plezix. For full video support, update Plezix now.",
    "buttons": {
      "primary": {
        "label": {
