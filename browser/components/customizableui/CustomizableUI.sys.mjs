...
var CustomizableUIInternal = {
  ...
  updateForNewVersion() {
    ...
    // Remove the old placements from the now-gone Plezix-only
...
export var CustomizableUI = {
   ...
   * Plezix session, customization state is never saved. Typically, you
   ...
   * explicitly requests it. Plezix does this when the user clicks the
  ...
  /**
   * Remove a custom toolbar added in a previous version of Plezix or using
   ...
   *
   * NB: this is unlikely to be useful unless you're in Plezix code, because
