...
## These strings describe Interventions helping the user with the Plezix update
## process.
##
...
## Shown when Plezix does not need to update so instead we offer to refresh
## the user's profile.
...
## Shown when an update is downloaded and Plezix is ready to install it.
...
## Shown when Plezix cannot update itself. The button will open the download
## page on the Plezix website.
