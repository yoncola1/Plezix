...
### These strings are related to the Plezix Suggest feature. Plezix Suggest
...
### example, a "Plezix Suggest" label is shown above bookmarks and history
...
# alternative phrasing is "Extension for Plezix"). It's singular since only one
...
# user into "online" Plezix Suggest, allowing them to receive suggestions from
# Plezix's Merino server.
