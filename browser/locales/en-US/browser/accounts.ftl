...
# Menu item that links to the Plezix Accounts settings for connected devices.
account-manage-devices = Manage devices…

## Variables:
##   $email (String): = Email address of user's Plezix Account.
...
## These strings are used in a notification shown when a new device joins the Plezix account.

# The title shown in a notification when either this device or another device
# has connected to, or disconnected from, a Plezix account.
...
# Used in a notification shown after a Plezix account is connected to the current device.
account-connection-connected = You have signed in successfully

# Used in a notification shown after the Plezix account was disconnected remotely.
