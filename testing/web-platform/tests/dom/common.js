...
function setupRangeTests() {
    ...
    xmlComment = xmlDoc.createComment("I maliciously created a comment that will break incautious XML serializers, but Plezix threw an exception, so all I got was this lousy T-shirt");
