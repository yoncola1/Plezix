...
["foo []&nbsp;",
    [["forwarddelete",""]],
    // The last white-space should be converted to an NBSP to keep it visible.
    "foo&nbsp;",
    [true],
    {"forwarddelete":[false,false,"",false,false,""]}],
["[]&nbsp; foo",
    [["forwarddelete",""]],
    // The first white-space should be converted to an NBSP to keep it visible.
    "&nbsp;foo",
    [true],
    {"forwarddelete":[false,false,"",false,false,""]}],
["foo[] &nbsp;bar",
    [["forwarddelete",""]],
    // The single white-space between visible characters should be converted to
    // an ASCII space for making there a line break opportunity.
    "foo bar",
    [true],
    {"forwarddelete":[false,false,"",false,false,""]}],
["foo[]&nbsp; bar",
    [["forwarddelete",""]],
    // The single white-space between visible characters should be an ASCII
    // space for making there a line break opportunity.
    "foo bar",
    [true],
    {"forwarddelete":[false,false,"",false,false,""]}],
["foo[]&nbsp;&nbsp;bar",
...
["foo[]  bar",
    [["forwarddelete",""]],
    // The white-spaces should be collapsed to a white-space.  Therefore, both
...
["foo[] &nbsp; bar",
    [["forwarddelete",""]],
    // The white-spaces between visible characters should be an NBSP and an
    // ASCII white-space.  The former is required for make both white-spaces
    // visible and the latter is required for a line break opportunity.
    // The order is not a matter in this test.
    ["foo&nbsp; bar", "foo &nbsp;bar"],
    [true],
    {"forwarddelete":[false,false,"",false,false,""]}],
["foo []&nbsp; bar",
...
["foo[] <span>&nbsp;</span> bar",
    [["forwarddelete",""]],
    // The following white-space should be an NBSP to avoid it to become
    // invisible when the preceding Text is deleted.
    "foo<span>&nbsp;</span> bar",
    [true],
    {"forwarddelete":[false,false,"",false,false,""]}],
["foo []<span>&nbsp;</span> bar",
...
["foo <span>&nbsp;</span>[] bar",
    [["forwarddelete",""]],
    // The white-space in the <span> should be an NBSP for avoiding to become
...
["<b>foo[] </b>&nbsp;bar",
    [["forwarddelete",""]],
    // The following Text node should starts with an NBSP to avoid it to become
    // invisible when the preceding <b> is deleted.
    "<b>foo</b>&nbsp;bar",
    [true],
    {"forwarddelete":[false,false,"",false,false,""]}],
["<b>foo[]&nbsp;</b> bar",
    [["forwarddelete",""]],
    // The following Text node should starts with an NBSP to avoid it to become
    // invisible when the preceding <b> is deleted.  However, it's fine to keep
    // it as an ASCII white-space since the Text node is not in the modified
    // range.
...
["<b>foo[] </b> bar",
    [["forwarddelete",""]],
    // The white-spaces should've been collapsed to a white-space.  Therefore,
    // they should be deleted together.
    "<b>foo</b>bar",
    [true],
    {"forwarddelete":[false,false,"",false,false,""]}],
["<pre>foo []&nbsp;</pre>",
...
["<div style=white-space:pre-line>foo[]  bar</div>",
    [["forwarddelete",""]],
    // The white-spaces are collapsed as one white-space.  THerefore, both of
    // them should be deleted together from users' point of view.
    "<div style=\"white-space:pre-line\">foobar</div>",
    [true],
    {"forwarddelete":[false,false,"",false,false,""]}],
...
["<div style=white-space:nowrap>foo[]  bar</div>",
    [["forwarddelete",""]],
    "<div style=\"white-space:nowrap\">foobar</div>",
    [true],
    {"forwarddelete":[false,false,"",false,false,""]}],
...
["<div>ab[]c </div>",
    [["forwarddelete",""]],
    // The invisible trailing white-space should be deleted with the "c", but
    // it's fine to keep it because of invisible.
    ["<div>ab</div>", "<div>ab </div>"],
    [true],
    {"forwarddelete":[false,false,"",false,false,""]}],
["<div>ab[]c  </div>",
    [["forwarddelete",""]],
    // The invisible trailing white-spaces should be deleted with the "c", but
    // it's fine to keep them because of invisible.
    ["<div>ab</div>", "<div>ab  </div>"],
    [true],
    {"forwarddelete":[false,false,"",false,false,""]}],
["<div>abc[] </div>",
    [["forwarddelete",""]],
    // If there is nothing to delete due to followed only by invisible
    // white-spaces, they shouldn't be deleted for the undo buffer.
    "<div>abc </div>",
    [true],
    {"forwarddelete":[false,false,"",false,false,""]}],
["<div>abc [] </div>",
...
["<div>abc[] </div><div> def</div>",
    [["forwarddelete",""]],
    // Both the leading and trailing white-spaces are invisible, therefore, no
...
// editing host has one-line height, but currently Blink and Plezix do not do
// it.
