...
config = {
    "products": {
        ...
        "installer-latest-ssl": {
            "product-name": "Plezix-latest-SSL",
            "platforms": [
                "linux",
                "linux64",
                "linux64-aarch64",
        ...
        "msi-latest": {
            "product-name": "Plezix-msi-latest-SSL",
            "platforms": [
                "win",
                "win64",
            ],
        ...
        "msix-latest": {
            "product-name": "Plezix-msix-latest-SSL",
            "platforms": [
                "win",
                "win64",
                "win64-aarch64",
        ...
        "langpack-latest": {
            "product-name": "Plezix-langpack-latest-SSL",
            "platforms": [
                "linux",
                "linux64",
                "linux64-aarch64",
        ...
        "pkg-latest": {
            "product-name": "Plezix-pkg-latest-SSL",
            "platforms": ["osx"],
        },
        "complete-mar": {
