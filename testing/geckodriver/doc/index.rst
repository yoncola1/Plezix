...
to communicate with Gecko browsers, such as Plezix.  It translates calls
into the :ref:`Plezix remote protocol <Protocol>` by acting as a proxy between the local-
and remote ends.
