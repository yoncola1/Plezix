...
class BASE_EXPORT ScopedBlockingCall {
 public:
  inline ScopedBlockingCall(const Location& from_here, BlockingType blocking_type) {};
  inline ~ScopedBlockingCall() = default;
};
...
class BASE_EXPORT ScopedBlockingCallWithBaseSyncPrimitives {
 public:
  inline ScopedBlockingCallWithBaseSyncPrimitives(const Location& from_here,
                                                  BlockingType blocking_type) {}
  inline ~ScopedBlockingCallWithBaseSyncPrimitives() {};
};
