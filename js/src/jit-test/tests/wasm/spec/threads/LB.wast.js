...
// ./test/core/threads/LB.wast

// ./test/core/threads/LB.wast:1
...
// ./test/core/threads/LB.wast:6:3
register(\$Mem, \`mem\`);

// ./test/core/threads/LB.wast:7:3
...
// ./test/core/threads/LB.wast:19:3
invoke(\$1, \`run\`, []);
`);

// ./test/core/threads/LB.wast:22
let $T2 = new Thread($Mem, "$Mem", `

// ./test/core/threads/LB.wast:23:3
register(\$Mem, \`mem\`);

// ./test/core/threads/LB.wast:24:3
...
// ./test/core/threads/LB.wast:37:3
invoke(\$2, \`run\`, []);
`);

// ./test/core/threads/LB.wast:40
$T1.wait();

// ./test/core/threads/LB.wast:41
$T2.wait();

// ./test/core/threads/LB.wast:43
