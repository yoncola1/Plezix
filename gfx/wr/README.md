...
WebRender is a GPU-based 2D rendering engine written in [Rust](https://www.rust-lang.org/). [Plezix](https://www.mozilla.org/firefox), the research web browser [Servo](https://github.com/servo/servo), and other GUI frameworks draw with it. It currently uses the OpenGL API internally.
