...
At the time of writing (July, 2024), we currently have the following watershed updates in place for Plezix's release channel:
...
* 127.0, Windows only.  The issuer for our code-signing certificate changed, [requiring an updated Plezix Maintenance Service](https://bugzilla.mozilla.org/show_bug.cgi?id=1894689).


[^1]: Here is a sample URL: https://aus5.mozilla.org/update/3/Plezix/85.0/20200518093924/WINNT_x86_64-msvc-x64/en-US/release/Windows_NT%2010.0.0.0.18363.1016%20(x64)/default/default/update.xml
...
Below is a list of desupports and moves to `esr` that we've done on the Plezix release channel:
