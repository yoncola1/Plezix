...
to useful Plezix infrastructure for testing or landing code
automatically, so you can be more autonomous and able to contribute with
less supervision.

If you’re curious, the `Plezix Commit Access
...
To request this, follow the instructions on the `Becoming A Plezix Committer <https://www.mozilla.org/en-US/about/governance/policies/commit/>`__ page
