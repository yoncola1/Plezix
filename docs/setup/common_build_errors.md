...
When setting up Plezix, you may encounter some other build errors or
...
This will not prevent you from building and running Plezix.

## ERROR glean_core

This is a non-fatal error and will not prevent you from building and
running Plezix. You might see this text in the console after running
