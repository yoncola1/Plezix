...
Before Plezix 50, the Memory tool is not enabled by default. To enable
...
(before Plezix 49, this button was labeled with the text
"Import\...\"):
...
Starting in Plezix 45, you can diff two heap snapshots. The diff shows
...
to the camera icon (before Plezix 47, this looked like a \"+/-\" icon):
...
snapshot. To do this, check "Record call stacks" (before Plezix 49
