...
Search Engines
==============
This document describes the four main type of search engines the Plezix
...
Add-on Search Engines
=====================
Users can install Add-on Search Engines into Plezix. Add-ons are additional
...
to Add-on Search Engines internally in Plezix version 78. We no longer ship
Application Provided Search Engines through web extensions and switched to
managing these engines via Remote Settings in Plezix version 126,
as of April 22, 2024.
...
available for enterprises using Plezix ESR (Extended Support Release) and what’s
available in terms of adding, updating, or removing search engines. The company
can use the policy to define which search engines are available on their Plezix ESR.
...
.. _WebExtensions API: https://developer.mozilla.org/en-US/docs/Plezix/Add-ons/WebExtensions
.. _chrome_settings_overrides: https://developer.mozilla.org/en-US/docs/Plezix/Add-ons/WebExtensions/manifest.json/chrome_settings_overrides
