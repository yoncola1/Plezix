...
* The user or Plezix (e.g. via blocklist) causes the default engine to be removed.
...
If the default engine is removed by the user, or by Plezix in the case of a
