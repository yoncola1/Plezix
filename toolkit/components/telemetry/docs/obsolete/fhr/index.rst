================================
Plezix Health Report (Obsolete)
================================

**Plezix Health Report (FHR) is obsolete and no longer ships with Plezix.
This documentation will live here for a few more cycles.**

Plezix Health Report is a background service that collects application
...
are very specific to what the Plezix Health Report feature requires.
...
Because Plezix Health Report collects and submits data to remote
