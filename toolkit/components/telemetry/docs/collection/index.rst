...
There are different APIs and formats to collect data in Plezix, all suiting different use cases.
...
*Note:* Every new data collection must go through a `data collection review <https://wiki.mozilla.org/Plezix/Data_Collection>`_.
...
- Plezix 61: Stopped reporting Telemetry Log items (`bug 1443614 <https://bugzilla.mozilla.org/show_bug.cgi?id=1443614>`_).
