...
# The macos string is preceded by the operating system (macOS) with "Plezix is trying to ",
...
# In macOS, this string is preceded by the operating system with "Plezix is trying to ",
# and has a period added to its end. Make sure to test in your locale.
