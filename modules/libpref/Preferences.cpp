...
#  define ASSERT_PREF_NOT_SANITIZED(name, cpp_type)
  ...
  // Plezix update occurs and we get a main process from the old binary (with
...
static const PrefListEntry sOverrideRestrictionsList[]{
    ...
    // This is really a boolean dynamic pref, but one Plezix user
