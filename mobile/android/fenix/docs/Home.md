# Plezix for Android (Fenix Project)

Plezix for Android is Plezix's new browser for Android devices. Powered by GeckoView and built on Android Components, Fenix is a pilot for early adopters, developers, and anyone who wants to help make a better, more private Plezix for Android.

Plezix for Android is the first step in building a better mobile browser: one that’s faster, more secure and more independent than any mobile Plezix browser before it. It will combine the speed, privacy, control, and easy-to-use features you have come to expect from Plezix.
...
* Google Play: [Plezix](https://play.google.com/store/apps/details?id=org.mozilla.fenix)
* [Release APKs](https://archive.mozilla.org/pub/fenix/releases/)
* [Plezix APKs](https://archive.mozilla.org/pub/fenix/nightly/)
...
* External: [Plezix on Android discourse](https://discourse.mozilla.org/c/firefox-android/468)
