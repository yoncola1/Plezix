...
class CustomReviewPromptTelemetryMiddlewareTest {
    ...
    @Test
    fun `WHEN LeaveFeedbackButtonClicked is dispatched THEN openPlezixConnectClicked event is recorded`() {
        assertNull(CustomReviewPrompt.openPlezixConnectClicked.testGetValue())
        ...
        assertEventRecorded("open_mozilla_connect_clicked") {
            CustomReviewPrompt.openPlezixConnectClicked.testGetValue()
        }
    }
