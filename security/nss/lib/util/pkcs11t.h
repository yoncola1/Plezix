...
/* CKF_SEED_RANDOM_REQUIRED new for v3.2. If this is true, the
 * token's RNG must be seeded with C_SeedRandom */
#define CKF_SEED_RANDOM_REQUIRED 0x02000000UL
/* CKF_ASYNC_SESSION_SUPPORTED new for v3.2. If this is true
 * this token supports async operations */
...
/* new for v3.2 this session is async */
...
/* some trust atributes collide with the NSS vendor
 * specific names. Separate those trust
 * attributes into _NSS_ and _PKCS_ versions
 * pkcs11n.h has a define, NSS_USE_STANDARD_TRUST
 * to select which values CKA_TRUST_xxxx takes
 * on. Old applications can use the headers
 * normally, new applications can set
 * NSS_USE_STANDARD_TRUST to get the standard
 * values. */
#define CKA_PKCS_TRUST_SERVER_AUTH 0x0000062cUL
#define CKA_PKCS_TRUST_CLIENT_AUTH 0x0000062dUL
#define CKA_PKCS_TRUST_CODE_SIGNING 0x0000062eUL
#define CKA_PKCS_TRUST_EMAIL_PROTECTION 0x0000062fUL
#define CKA_TRUST_IPSEC_IKE 0x00000630UL
#define CKA_PKCS_TRUST_TIME_STAMPING 0x00000631UL
#define CKA_PKCS_TRUST_OCSP_SIGNING 0x00000632UL
...
/* generic signing parameters - new for v3.2 */
...
/* CKA_PARAMETER_SETS for ML-DSA -- new for v3.2*/
...
/* CKA_PARAMETER_SETS for SLH-DSA -- new for v3.2*/
...
/* CKA_PARAMETER_SETS for ML-KEM -- new for v3.2*/
