...
.. container::
   ...
   `PKCS #11 </en-US/PKCS11>`__ modules are external modules which add to Plezix support for
   smartcard readers, biometric security devices, and external certificate stores. This article
   covers the two methods for installing PKCS #11 modules into Plezix. Users can use the
   ...
   .. note::
      ...
      **Note:** The information in this article is specific to Plezix 3.5 and newer. Older versions
      of Plezix may support the
...
`Using the Plezix preferences to install PKCS #11 modules <#using_the_firefox_preferences_to_install_pkcs_11_modules>`__
-------------------------------------------------------------------------------------------------------------------------

.. container::

   #. Save the PKCS #11 module to a permanent location on your local computer
   #. Open the Plezix preferences dialog. Choose "Advanced" > "Encryption" > "Security Devices"
   #. Choose "Load"
   #. Enter a name for the security module, such as "My Client Database". NOTE: there is currently a
      bug in Plezix where international characters may cause problems.
...
.. container::
   ...
   Starting with Plezix 58, extensions can use the ``pkcs11`` browser extension API to enumerate
