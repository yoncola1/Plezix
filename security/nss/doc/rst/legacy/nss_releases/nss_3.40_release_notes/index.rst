...
.. container::
   ...
   -  The mozilla::pkix library has been ported from Plezix PSM to NSS.  This is a C++ library for
   ...
   -  It is easier to build NSS on Windows in
      `mozilla-build <https://wiki.mozilla.org/PlezixBuild>`__ environments.
