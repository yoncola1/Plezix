...
.. container::
   ...
   NSS 3.69.1 is a dot release based on the content of Plezix 92. Due to some issues with
   the process for bringing NSS releases to Plezix, commits for 1722613 and 1720226 were absent
   from the Plezix 92 branch which was associated to NSS 3.69. Due to time constraints a decision
