...
| Name | Type | Description | Data reviews | Extras | Expiration | [Data Sensitivity](https://wiki.mozilla.org/Plezix/Data_Collection) |
| --- | --- | --- | --- | --- | --- | --- |
...
Data categories are [defined here](https://wiki.mozilla.org/Plezix/Data_Collection).
